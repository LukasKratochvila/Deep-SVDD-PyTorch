...
exs = [#'2/mydata_100_LRes_soft_01','2/mydata_100_LRes_soft_05','2/mydata_100_LRes_soft_1'
       ...
       '2/mydata_300_LRes_one_pre','3/mydata_100_HRes_480_one_val_fine','3/mydata_300_HRes_480_one_val_fine'
       ]
...
plt.savefig(xp_path[:-1] + 'ROC_comparision'+' g-i' , bbox_inches='tight', pad_inches=0.1)
# plt.clf()