...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 25 16:56:41 2020
...
class MY_LeNet_480(BaseNet):
    ...
    def __init__(self):
        ...
        self.fc1 = nn.Linear(128 * 15 * 15, self.rep_dim, bias=False) # 20 * 15
...
class MY_LeNet_480_Autoencoder(BaseNet):
    ...
    def __init__(self):
        ...
        self.bn2d5 = nn.BatchNorm2d(128, eps=1e-04, affine=False)
        self.fc1 = nn.Linear(128 * 15 * 15, self.rep_dim, bias=False)
        self.bn1d = nn.BatchNorm1d(self.rep_dim, eps=1e-04, affine=False)

        # Decoder
        self.deconv1 = nn.ConvTranspose2d(int(self.rep_dim / (15 * 15)), 128, 5, bias=False, padding=2)
        ...
        self.bn2d9 = nn.BatchNorm2d(16, eps=1e-04, affine=False)
        self.deconv5 = nn.ConvTranspose2d(16, 8, 5, bias=False, padding=2)
        nn.init.xavier_uniform_(self.deconv5.weight, gain=nn.init.calculate_gain('leaky_relu'))
        self.bn2d10 = nn.BatchNorm2d(8, eps=1e-04, affine=False)
        self.deconv6 = nn.ConvTranspose2d(8, 3, 5, bias=False, padding=2)
    ...
    def forward(self, x):
        ...
        x = x.view(x.size(0), int(self.rep_dim / (15 * 15)), 15, 15)
        x = F.leaky_relu(x)
        x = self.deconv1(x)
